...
The project demonstrates deploying a C# Windows desktop application using the **Windows Installer XML (WiX) Toolset**. The application developed for this task is a simple **Study Task Manager** built with Windows Forms.
